...
CREATE TABLE
  IF NOT EXISTS `classes_teachers` (
    `id` int (11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE
  IF NOT EXISTS `exercisessubmits` (
    `id` int (11) NOT NULL AUTO_INCREMENT,
    `studentId` int (11) DEFAULT NULL,
    `content` text DEFAULT NULL,
    `attachment` varchar(200) DEFAULT NULL,
...
CREATE TABLE
  IF NOT EXISTS `learningstatuses` (
    `id` int (11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO
  `learningstatuses` (`id`, `name`, `createdAt`, `updatedAt`)
VALUES
  (
    1,
    'Studying',
...
INSERT INTO
  `logintokens` (`id`, `token`, `userId`, `createdAt`, `updatedAt`)
VALUES
  (
    4,
    '5cbdf033d1581cd2f25c959dfb6d591a',
    1,
    '2024-02-01 14:32:12',
    '2024-02-01 14:32:12'
  );
...
INSERT INTO
  `permissions` (`id`, `values`, `createdAt`, `updatedAt`)
VALUES
  (
    1,
    'users.read',
...
CREATE TABLE
  IF NOT EXISTS `studentsattendances` (
    `id` int (11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE
  IF NOT EXISTS `teachercalendars` (
    `id` int (11) NOT NULL AUTO_INCREMENT,
    `teacherId` int (11) DEFAULT NULL,
    `classId` int (11) DEFAULT NULL,
...
INSERT INTO
  `types` (`id`, `name`, `createdAt`, `updatedAt`)
VALUES
  (
    1,
    'Admin',
...
VALUES
  (
    ...
    '$2b$10$rY99YGCQ05RFoPoun0TT7.WVOZj5SgjdiLcTJYoMtZ/iYO7OZwcS6',
    '012354631',
    'Hà Nội',
    1,
    0,
  ...
  (
    ...
    'Sơn Đặng',
    'sondang@gmail.com',
    '$2b$10$wr9x3WyaL54q30mf0dvh0e7FnAyQajlUDY3QXmIKhs59d68SWZbHO',
    '012354631',
    'Hà Nội',
    2,
    0,
  ...
  (
    ...
    'Hoàng An',
    'hoangan@gmail.com',
    '$2b$10$2VR91thyjANVaM3ePKUvNuwzsObq/90fKq2QxX5dva4ehxHEQjMSm',
    '012354631',
    'Hà Nội',
    2,
    0,
